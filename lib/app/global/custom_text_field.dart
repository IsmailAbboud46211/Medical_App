...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      obscureText: widget.isPasswordTextField == true ? !isPasswordVisible : false,
      cursorColor: AppColors.seconderyColor,
      decoration: InputDecoration(
        hoverColor: AppColors.seconderyColor,
        errorStyle: TextStyle(
          color: widget.errorMessageColor,
          fontWeight: FontWeight.bold,
        ),
        labelStyle: TextStyle(color: AppColors.seconderyColor),
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderRadius: BorderRadius.all(
            Radius.circular(context.width * 0.5),
          ),
        ),
